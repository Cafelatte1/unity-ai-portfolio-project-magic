...
마크다운 형식의 Document 파일들과 Unity용 스크립트(C#)가 담긴 Asset/Scrips/ 폴더 및 Intel OpenVINO 기반 On-Device 추론용 스크립트(C++)가 담긴 Asset/DLL/project-magic-localai/ 폴더 내 파일들을 참고해 주시기 바랍니다.
클로드 기반 모델들로 코드 평가를 진행하며 여러 문제를 개선시켜왔고 CodeEvaluation/ 내 히스토리를 저장해 놓았습니다.
