...
- 실제 구현 내용은 Unity용 스크립트가 담긴 Asset/Scrips/ 폴더 및 **Intel OpenVINO 기반 On-Device 추론용 스크립트**가 담긴 Asset/DLL/project-magic-localai/ 폴더 내 파일들을 확인해 주세요.
- 클로드 4.5 모델을 활용해 코드 리뷰를 기반으로 꾸준히 개선해 왔으며 진행 히스토리는 CodeEvaluation/ 폴더에 정리해 두었으니 참고해 주세요.
